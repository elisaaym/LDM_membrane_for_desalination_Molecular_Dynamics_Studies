function [ x, y, z, atomtype, charge, n_y, n_z,n ] = construct_MXeneTi3C2O2( size_y, size_z, x_start, y_start, z_start, slitsize )
...
%next top slab
y_init = y_slit_top+0.5;
z_init = z_start;
x_init = x_start;
for k = 1:n_z
    %Check if range of y values for this cell is at least partially > 0
    while(y_init+a <y_slit_top)
        y_init = y_init+a;
    end
    y_init_first = y_init;
    for j = 1:n_y/2
