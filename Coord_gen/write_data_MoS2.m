...
size_H2O_y = 40.15; %Must be a multiple of 3*1.42 to ensure good graphene lattice with periodic BC. Even multiple so we can define z properly
size_H2O_z = 53.9;
size_H2O_x = 56.715*2;
dia_x =3.241;
...
[ xm, ym, zm, atomtype_m, n_ym, n_zm,n_m ] = construct_MoS2_Mo(size_H2O_y, size_H2O_z,3+size_H2O_x+3, 0, 0, slitsize );
