...
size_H2O_y = 34.16; %Must be a multiple of 3*1.42 to ensure good graphene lattice with periodic BC. Even multiple so we can define z properly
size_H2O_z = 52.98;
size_H2O_x = 56.715*2;
dia_x =4.77;
...
[ xm, ym, zm, atomtype_M, n_ym, n_zm,n_M ] = construct_MXene( size_H2O_y,size_H2O_z , 3+size_H2O_x+3, 0, 0, slitsize );
