...
a2 = 1.614;
a1 = 2.866;
size_H2O_y =76*a2; %Must be a multiple of a2 to ensure good lattice with periodic BC. Even multiple so we can define z properly
size_H2O_x = 42*a1; %Multiple of a1
size_H2O_z = 120;
n_y = ceil(size_H2O_y/a2);
n_x = ceil(size_H2O_x/a1);
...
%bonds
[ zb, yb, xb, atomtype_B, n_yb, n_xb,num_B ] = construct_borophene( size_H2O_y,size_H2O_x,0, 0, 0, 0 );


%2 times the water molecules + salt ions + carbon
num_atoms = num_atoms + num_B;
...
fprintf(fid, formatspec, 0, size_H2O_z+40);
